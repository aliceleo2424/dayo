...
(function () {
  ...
  var DICT = {
    ...
    'partner.sessions.enter': {
      KO: '☕ 스튜디오 입장', EN: '☕ Join conversation', ZH: '☕ 进入工作室', JA: '☕ スタジオ入室', FR: '☕ Entrer', ES: '☕ Entrar'
    },
    ...
    'tickets.title': {
      ...
      ZH: '轻松续上的会话套餐',
      JA: '気軽に続けられるセッション利用券',
      FR: 'Des passes de session, sans engagement',
      ES: 'Pases de sesión, tan ligeros como necesites'
    },
    'tickets.desc': {
      KO: '첫 체험 9,900원부터 깔끔한 1회 티켓, 산뜻한 3회, 11·33 패키지까지, 약정 없이 필요한 만큼만 충전해요.',
      EN: 'From the ₩9,900 trial to a single ticket and 3/11/33-session packs. Top up only what you need — no commitment.',
      ZH: '从9,900韩元首次体验到单次票及3/11/33次套餐，无需合约，按需充值。',
      JA: '初回9,900ウォンから1回券、3・11・33回パッケージまで。契約なしで必要な分だけチャージ。',
      FR: 'De l’essai à 9 900 ₩ au ticket unique et aux packs de 3/11/33 séances, sans engagement.',
      ES: 'Desde la prueba de ₩9,900 hasta un ticket único y packs de 3/11/33 sesiones, sin compromiso.'
    },
    ...
    'tickets.first.note': { KO: '1회 한정 특별 혜택', EN: 'One-time special offer', ZH: '限1次特别优惠', JA: '1回限定の特別特典', FR: 'Offre spéciale, une seule fois', ES: 'Oferta especial de una sola vez' },
    'tickets.single.title': { KO: '깔끔한 1회 티켓', EN: 'Simple single ticket', ZH: '轻松单次票', JA: 'すっきり1回チケット', FR: 'Ticket unique', ES: 'Ticket individual' },
    'tickets.single.price': { KO: '19,900원 · 1회 30분', EN: '₩19,900 · 30 min', ZH: '19,900韩元 · 30分钟', JA: '19,900ウォン · 30分', FR: '19 900 ₩ · 30 min', ES: '₩19,900 · 30 min' },
    'tickets.single.note': { KO: '약정 없이 필요할 때 딱 한 번', EN: 'One session whenever you need it', ZH: '无需合约，按需使用一次', JA: '契約なしで必要なときに1回', FR: 'Une session quand vous en avez besoin', ES: 'Una sesión cuando la necesites' },
    ...
    'tickets.starter.note': { KO: '부담 없는 3주 루틴', EN: 'An easy 3-week routine', ZH: '轻松的3周练习', JA: '無理のない3週間ルーティン', FR: 'Une routine légère sur 3 semaines', ES: 'Una rutina ligera de 3 semanas' },
    ...
    'tickets.best.note': { KO: '회당 약 16,270원 (10+1회)', EN: 'About ₩16,270 each (10+1)', ZH: '每次约16,270韩元（10+1次）', JA: '1回約16,270ウォン（10+1回）', FR: 'Env. 16 270 ₩ / séance (10+1)', ES: 'Unos ₩16,270 por sesión (10+1)' },
    ...
    'quiz.speaking.title': { KO: '마이크로 직접 말해보는 1분 테스트 🎙️', EN: 'A one-minute speaking check with your mic 🎙️', ZH: '用麦克风开口说的1分钟测试 🎙️', JA: 'マイクで実際に話す1分テスト 🎙️', FR: 'Un test oral d’une minute avec votre micro 🎙️', ES: 'Una prueba oral de un minuto con tu micrófono 🎙️' },
    'quiz.speaking.intro': { KO: '선택한 언어로 쉬운 질문 3개에 답해보세요. 정답도, 문법 점수도 없어요.', EN: 'Answer three easy questions in your chosen language. There are no right answers or grammar scores.', ZH: '请用所选语言回答3个简单问题。没有标准答案，也不评分语法。', JA: '選んだ言語で、やさしい3つの質問に答えてみましょう。正解も文法点数もありません。', FR: 'Répondez à trois questions simples dans la langue choisie. Pas de bonne réponse ni de note de grammaire.', ES: 'Responde tres preguntas fáciles en el idioma elegido. No hay respuestas correctas ni nota de gramática.' },
    'quiz.speaking.privacy': { KO: '마이크 권한이 필요해요. 인식된 문장은 이 테스트 결과를 만드는 데만 사용하며 서버에 저장하지 않아요.', EN: 'Microphone permission is required. Recognized speech is used only for this result and is not stored on our server.', ZH: '需要麦克风权限。识别内容只用于生成本次结果，不会存到服务器。', JA: 'マイクの許可が必要です。認識した内容は今回の結果にだけ使い、サーバーには保存しません。', FR: 'L’accès au micro est requis. Le texte reconnu sert uniquement à ce résultat et n’est pas stocké sur notre serveur.', ES: 'Se necesita permiso para el micrófono. El texto reconocido solo se usa para este resultado y no se guarda en el servidor.' },
    'quiz.speaking.start': { KO: '마이크 테스트 시작하기', EN: 'Start the mic test', ZH: '开始麦克风测试', JA: 'マイクテストを始める', FR: 'Commencer le test micro', ES: 'Empezar la prueba de micrófono' },
    'quiz.speaking.hint': { KO: '힌트: {hints}', EN: 'Hints: {hints}', ZH: '提示：{hints}', JA: 'ヒント：{hints}', FR: 'Mots utiles : {hints}', ES: 'Pistas: {hints}' },
    'quiz.speaking.instruction': { KO: '마이크를 누르고 10~20초 정도 편하게 말해보세요.', EN: 'Tap the mic and speak naturally for about 10–20 seconds.', ZH: '点击麦克风，自然地说约10到20秒。', JA: 'マイクを押して、10〜20秒ほど気楽に話してください。', FR: 'Touchez le micro et parlez naturellement pendant 10 à 20 secondes.', ES: 'Pulsa el micrófono y habla con naturalidad durante unos 10–20 segundos.' },
    'quiz.speaking.micStart': { KO: '눌러서 말하기', EN: 'Tap to speak', ZH: '点击开始说话', JA: '押して話す', FR: 'Toucher pour parler', ES: 'Pulsa para hablar' },
    'quiz.speaking.micStop': { KO: '말하기 종료', EN: 'Stop speaking', ZH: '结束说话', JA: '話し終える', FR: 'Arrêter de parler', ES: 'Terminar de hablar' },
    'quiz.speaking.listening': { KO: '듣는 중… 다시 누르면 종료돼요', EN: 'Listening… tap again to stop', ZH: '正在聆听…再次点击即可结束', JA: '聞いています…もう一度押すと終了します', FR: 'Écoute en cours… touchez à nouveau pour arrêter', ES: 'Escuchando… pulsa otra vez para terminar' },
    'quiz.speaking.speakNow': { KO: '지금 편하게 말해보세요.', EN: 'Go ahead and speak naturally.', ZH: '现在请自然地说出来。', JA: '今、気楽に話してみてください。', FR: 'Parlez maintenant, tout simplement.', ES: 'Habla ahora con naturalidad.' },
    'quiz.speaking.processing': { KO: '말한 내용을 정리하고 있어요…', EN: 'Finishing your response…', ZH: '正在整理你的回答…', JA: '話した内容をまとめています…', FR: 'Finalisation de votre réponse…', ES: 'Terminando tu respuesta…' },
    'quiz.speaking.transcriptEmpty': { KO: '인식된 문장이 여기에 보여요.', EN: 'Your recognized speech will appear here.', ZH: '识别出的内容会显示在这里。', JA: '認識された内容がここに表示されます。', FR: 'Le texte reconnu apparaîtra ici.', ES: 'El texto reconocido aparecerá aquí.' },
    'quiz.speaking.captured': { KO: '좋아요! 발화를 인식했어요.', EN: 'Great! We heard your response.', ZH: '很好！已识别你的回答。', JA: 'いいですね！発話を認識しました。', FR: 'Très bien ! Votre réponse a été reconnue.', ES: '¡Muy bien! Reconocimos tu respuesta.' },
    'quiz.speaking.retry': { KO: '다시 말하기', EN: 'Try again', ZH: '重新说', JA: 'もう一度話す', FR: 'Recommencer', ES: 'Hablar de nuevo' },
    'quiz.speaking.next': { KO: '다음 질문', EN: 'Next question', ZH: '下一个问题', JA: '次の質問', FR: 'Question suivante', ES: 'Siguiente pregunta' },
    'quiz.speaking.unsupported': { KO: '음성 인식을 지원하지 않아요', EN: 'Speech recognition is not supported', ZH: '不支持语音识别', JA: '音声認識に対応していません', FR: 'La reconnaissance vocale n’est pas prise en charge', ES: 'El reconocimiento de voz no es compatible' },
    'quiz.speaking.unsupportedHelp': { KO: 'Chrome 또는 Safari 최신 버전에서 다시 열어주세요.', EN: 'Please reopen this page in the latest Chrome or Safari.', ZH: '请使用最新版Chrome或Safari重新打开。', JA: '最新版のChromeまたはSafariで開き直してください。', FR: 'Rouvrez cette page dans la dernière version de Chrome ou Safari.', ES: 'Abre esta página en la última versión de Chrome o Safari.' },
    'quiz.speaking.permissionDenied': { KO: '마이크 권한이 차단됐어요. 브라우저 설정에서 권한을 허용한 뒤 다시 눌러주세요.', EN: 'Microphone access is blocked. Allow it in your browser settings, then try again.', ZH: '麦克风权限已被阻止。请在浏览器设置中允许后重试。', JA: 'マイクの許可がブロックされています。ブラウザ設定で許可してから再試行してください。', FR: 'L’accès au micro est bloqué. Autorisez-le dans le navigateur, puis réessayez.', ES: 'El acceso al micrófono está bloqueado. Permítelo en el navegador y vuelve a intentarlo.' },
    'quiz.speaking.noSpeech': { KO: '목소리가 인식되지 않았어요. 마이크 가까이에서 다시 말해보세요.', EN: 'We could not hear speech. Try again closer to the microphone.', ZH: '没有识别到声音。请靠近麦克风再试一次。', JA: '声を認識できませんでした。マイクに近づいてもう一度話してください。', FR: 'Aucune parole reconnue. Réessayez plus près du micro.', ES: 'No se reconoció voz. Acércate al micrófono e inténtalo de nuevo.' },
    'quiz.speaking.error': { KO: '음성 인식이 잠시 중단됐어요. 다시 눌러주세요.', EN: 'Speech recognition stopped for a moment. Please try again.', ZH: '语音识别暂时中断。请重试。', JA: '音声認識が一時停止しました。もう一度お試しください。', FR: 'La reconnaissance vocale s’est interrompue. Réessayez.', ES: 'El reconocimiento de voz se detuvo. Inténtalo de nuevo.' },
    'quiz.speaking.completed': { KO: '3단계 중 {completed}단계에서 실제로 말했어요', EN: 'You spoke in {completed} of {total} steps', ZH: '你在{total}个步骤中的{completed}个开口说了', JA: '{total}ステップ中{completed}ステップで実際に話しました', FR: 'Vous avez parlé à {completed} étapes sur {total}', ES: 'Hablaste en {completed} de {total} pasos' },
    'quiz.speaking.resultTitle': { KO: '지금의 스피킹 감각을 가볍게 살펴봤어요.', EN: 'Here is a light snapshot of how speaking felt today.', ZH: '这是你今天开口感觉的简单记录。', JA: '今のスピーキング感覚を気軽に振り返りました。', FR: 'Voici un aperçu léger de votre aisance à parler aujourd’hui.', ES: 'Este es un vistazo ligero a cómo te sentiste hablando hoy.' },
    'quiz.speaking.senseLabel': { KO: '이번 발화에서 관찰한 점', EN: 'What we observed this time', ZH: '本次发言中的观察', JA: '今回の発話で見えたこと', FR: 'Ce que nous avons observé', ES: 'Lo que observamos esta vez' },
    'quiz.speaking.metric.open': { KO: '말문 열기', EN: 'Starting to speak', ZH: '开口说话', JA: '話し始める', FR: 'Commencer à parler', ES: 'Empezar a hablar' },
    'quiz.speaking.metric.sentence': { KO: '짧은 문장 만들기', EN: 'Making a short response', ZH: '说出简短句子', JA: '短い文を作る', FR: 'Former une réponse courte', ES: 'Crear una respuesta corta' },
    'quiz.speaking.metric.continue': { KO: '이어 말하기', EN: 'Keeping it going', ZH: '继续说下去', JA: '話を続ける', FR: 'Continuer à parler', ES: 'Seguir hablando' },
    'quiz.speaking.metric.done': { KO: '해냈어요', EN: 'Done', ZH: '做到了', JA: 'できました', FR: 'Réussi', ES: 'Hecho' },
    'quiz.speaking.metric.try': { KO: '천천히 시작해도 괜찮아요', EN: 'A slow start is okay', ZH: '慢慢开始也没关系', JA: 'ゆっくり始めて大丈夫', FR: 'Commencer doucement, c’est très bien', ES: 'Está bien empezar despacio' },
    'quiz.speaking.metric.practice': { KO: '조금 더 이어가 봐요', EN: 'Try adding a little more', ZH: '试着再多说一点', JA: 'もう少し続けてみよう', FR: 'Essayez d’ajouter un peu plus', ES: 'Intenta añadir un poco más' },
    ...
    'room.toastSttOff': { KO: '', EN: '', ZH: '', JA: '', FR: '', ES: '' },
    ...
    'room.partner.previewStatus': { KO: '파트너 화면 미리보기', EN: 'Partner view preview' },
    'room.partner.liveStatus': { KO: '유저와 1:1 대화 중', EN: 'In a 1:1 conversation with the user' },
    'room.partner.previewName': { KO: '파트너 (Partner)', EN: 'Conversation Partner' },
    'room.partner.userName': { KO: '유저 (User)', EN: 'User' },
    'room.partnerReport.transcriptTitle': { KO: '💬 25분 대화 스크롤 로그', EN: '💬 Conversation transcript' },
    'room.partnerReport.title': { KO: '✨ 파트너 피드백 & 오늘의 대화 기록', EN: '✨ Feedback & Conversation Notes' },
    'room.partnerReport.commentLabel': { KO: '1. 파트너 다정 코멘트 (직접 입력 또는 AI 추천 칩 탭)', EN: '1. A short note for the user' },
    'room.partnerReport.commentPlaceholder': { KO: '유저에게 따뜻한 응원의 한마디를 남겨주세요.', EN: 'Leave a short, encouraging note.' },
    ...
    'room.partnerReport.cardSection': { KO: '4. <From DayO> 인스타 카드 선택 & 문장 매칭', EN: '4. Choose a DayO card and sentence' },
    'room.partnerReport.regenerateAria': { KO: '다른 카드 재생성', EN: 'Generate another card' },
    'room.partnerReport.bestSentence': { KO: '대화 속 베스트 문장 선택:', EN: 'Choose the best sentence:' },
    'room.partnerReport.saveCard': { KO: '📸 카드 이미지 저장하기', EN: '📸 Save card image' },
    'room.partnerReport.autoPublish': { KO: '유저 마이페이지에 자동 발행', EN: 'Published automatically to the user page' },
    'room.partnerReport.submit': { KO: '✨ 검수 완료하고 6,000P 받기', EN: '✨ Submit notes and receive 6,000P' },
    'room.partnerReport.noCardTranscript': { KO: '인식된 학습자 발화가 없어 문장 카드를 저장하지 않습니다.', EN: 'No user speech was recognized, so no sentence card will be saved.' },
    'room.partnerReport.noTranscript': { KO: '아직 인식된 발화가 없습니다.<br>마이크를 켜고 영어로 말해 보세요.', EN: 'No speech has been recognized yet.<br>Turn on the mic and start speaking.' },
    'room.partnerReport.preview': { KO: '테스트 미리보기입니다. 실제 포인트는 지급되지 않아요.', EN: 'This is a preview. No points will be added.' },
    'room.partnerReport.saving': { KO: '대화 기록을 저장하고 포인트 지급을 확인하고 있어요.', EN: 'Saving conversation notes and checking your reward.' },
    'room.partnerReport.invalidBooking': { KO: '실제 예약 정보를 확인할 수 없어 포인트를 지급하지 않았어요. 파트너 라운지의 예약 세션으로 다시 입장해 주세요.', EN: 'We could not verify this booking. Please join again from Upcoming conversations.' },
    'room.partnerReport.transcriptFailed': { KO: '대화 기록 저장에 실패했어요. 잠시 후 다시 시도해 주세요.', EN: 'Could not save the conversation transcript. Please try again.' },
    'room.partnerReport.notesFailed': { KO: '파트너 검수 내용을 저장하지 못했어요. 잠시 후 다시 시도해 주세요.', EN: 'Could not save your conversation notes. Please try again.' },
    'room.partnerReport.authFailed': { KO: '로그인 정보를 확인할 수 없어 검수 내용을 저장하지 못했어요.', EN: 'Could not verify your login. Your notes were not saved.' },
    'room.partnerReport.completeFailed': { KO: '대화 기록을 완료하지 못했어요. 잠시 후 다시 시도해 주세요.', EN: 'Could not complete the conversation notes. Please try again.' },
    'room.partnerReport.rewardUnavailable': { KO: '포인트 지급 조건을 확인하지 못했어요. 예약 시간과 세션 상태를 확인한 뒤 다시 시도해 주세요.', EN: 'Could not confirm the reward. Check the booking and conversation status, then try again.' },
    'room.partnerReport.success': { KO: '오늘의 대화 기록을 전송했고 6,000P가 지급되었어요.', EN: 'Conversation notes submitted. Your 6,000P reward was added.' },
    ...
    'partner.photoModal.save': { KO: '✔ 이 사진으로 저장하기', EN: '✔ Save this photo' },
    ...
    'partner.badge.active': { KO: '🟢 파트너 활동중', EN: '🟢 Conversation Partner active' },
    'partner.status.active': { KO: '🟢 활동중', EN: '🟢 Active' },
    'partner.status.resting': { KO: '☕ 휴식중', EN: '☕ Paused' },
    'partner.status.activeTitle': { KO: '대화 예약 가능', EN: 'Available for conversations' },
    'partner.status.restingTitle': { KO: '예약 일시 중단', EN: 'Bookings paused' },
    'partner.toast.activated': { KO: '🟢 활동중으로 전환되었습니다. 예약이 가능해요!', EN: '🟢 You are active. Users can book your available times.' },
    'partner.toast.resting': { KO: '☕ 휴식중으로 전환되었습니다. 예약이 일시 중단돼요.', EN: '☕ You are paused. New bookings are temporarily unavailable.' },
    'partner.toast.serverUnavailable': { KO: '저장 서버에 연결할 수 없습니다.', EN: 'Could not connect to the server.' },
    'partner.toast.loginRequired': { KO: '로그인이 필요합니다.', EN: 'Please log in.' },
    'partner.toast.profileSaved': { KO: '프로필이 성공적으로 저장되었습니다 ✨', EN: 'Profile saved ✨' },
    'partner.toast.profileSaveFailed': { KO: '프로필 저장에 실패했습니다. 잠시 후 다시 시도해 주세요.', EN: 'Could not save your profile. Please try again.' },
    ...
    'partner.sessions.confirmed': { KO: '● 예약 확정', EN: '● Confirmed' },
    'partner.sessions.bookedTitle': { KO: '예약된 대화', EN: 'Upcoming conversation' },
    'partner.sessions.topicFormat': { KO: '주제: {topic}', EN: 'Topic: {topic}' },
    'partner.sessions.defaultTopic': { KO: '글로벌 대화', EN: 'Global conversation' },
    'partner.sessions.timeUnknown': { KO: '예약 시간 확인', EN: 'Check booking time' },
    'partner.schedule.saving': { KO: '⏳ 저장 중...', EN: '⏳ Saving...' },
    'partner.schedule.saved': { KO: '✅ 주간 대화 가능 시간이 성공적으로 저장되었습니다!', EN: '✅ Your available times were saved.' },
    'partner.schedule.serverError': { KO: '스케줄 저장 중 오류가 발생했습니다: 로그인 서버에 연결할 수 없습니다.', EN: 'Could not save availability: unable to connect to the login server.' },
    'partner.schedule.loginRequired': { KO: '로그인이 필요합니다.', EN: 'Please log in.' },
    'partner.schedule.saveErrorFormat': { KO: '스케줄 저장 중 오류가 발생했습니다: {message}', EN: 'Could not save availability: {message}' },
    'partner.settlement.title': { KO: '💰 포인트 적립 및 정산 내역', EN: '💰 Points and payouts' },
    'partner.settlement.desc': { KO: '세션 적립과 출금 내역을 한눈에 확인하세요.', EN: 'Review your rewards and payouts.' },
    'partner.settlement.pending': { KO: '이번 달 출금 대기', EN: 'Pending this month' },
    'partner.settlement.completed': { KO: '누적 정산 완료', EN: 'Total paid' },
